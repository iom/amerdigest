...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Mobility in the Americas Digest",
    Description = "Use a report template to automatically generate data digest.",
    `Authors@R` = c(
    person(
      "Kenneth S.", "Reyes",
      email = "kereyes@iom.int",
      role = c("aut", "cre")
    ),
    person(
      "Freddy Nicolas", "Marquez",
      email = "fmarquez@iom.int",
      role = c("aut" )
    )
  )
  )
